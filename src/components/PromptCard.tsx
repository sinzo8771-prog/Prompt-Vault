...
export function PromptCard({
  ...
  if (compact) {
    return (
      <div className="group relative p-4 bg-surface-container border border-border/50 rounded-xl hover:border-accent/30 transition-all">
  ...
  return (
    <div className="group relative bg-surface-container border border-border/50 rounded-xl hover:border-accent/30 transition-all duration-300 p-6 flex flex-col">
      {/* Accent line */}
      <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-accent rounded-l-xl opacity-0 group-hover:opacity-100 transition-opacity" />
